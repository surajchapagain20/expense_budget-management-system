		...
		if(empty($id)){
			...
			if($qry){
				...
				foreach($_POST as $k => $v){
					if($k != 'id' && $k != 'password'){
						if(!empty($data)) $data .=" , ";
						if(isset($_POST['id']) && $_POST['id'] == $this->settings->userdata('id'))
			...
			if($qry){
				...
				foreach($_POST as $k => $v){
					if($k != 'id' && $k != 'password'){
						if(!empty($data)) $data .=" , ";
						if(isset($id) && $id == $this->settings->userdata('id'))
						$this->settings->set_userdata($k,$v);
					}
				}
				if(isset($fname) && isset($move) && (isset($id) && $id == $this->settings->userdata('id')))
