...
<div class="card card-primary card-outline shadow-sm border-0" style="border-radius: 1.5rem;">
    <div class="card-header border-0 bg-transparent p-4">
        <h4 class="card-title font-weight-bold m-0"><i class="fas fa-file-invoice-dollar mr-2"></i> Expense Report</h4>
    </div>
    <div class="card-body p-4 pt-0">
        ...
        <div id="printable">
            <div class="text-center mb-4">
                ...
                <h3 class="m-0 text-primary"><b>Expense Report</b></h3>
            ...
            <table class="table table-bordered table-hover" id="reportTable">
                ...
                <tbody>
                    ...
                    $qry = $conn->query("SELECT r.*,c.category from `running_balance` r inner join `categories` c on r.category_id = c.id where c.status=1 and r.balance_type = 2 and date(r.date_created) between '{$date_start}' and '{$date_end}' {$where} order by unix_timestamp(r.date_created) asc");
                    ...
                    <tr>
                        ...
                        <td class="text-right font-weight-bold text-danger"><?php echo number_format($row['amount']) ?></td>
                ...
                <tfoot>
                    <tr class="bg-light">
                        ...
                        <th class="text-right py-3 text-danger h5 m-0 font-weight-bold"><?php echo number_format($total) ?></th>
...
<script>
    $(function(){
        ...
        $('#filter-form').submit(function(e){
            ...
            location.href = "./?page=reports/expense&date_start="+start+"&date_end="+end+"&category_id="+cat
        })
        ...
        $('#reportTable').DataTable({
            ...
            buttons: [
                ...
                {
                    extend: 'excelHtml5',
                    title: 'Expense Report - ' + '<?php echo date("M d Y", strtotime($date_start)) ?> to <?php echo date("M d Y", strtotime($date_end)) ?>',
